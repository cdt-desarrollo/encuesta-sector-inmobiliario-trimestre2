  ...
  Swal.fire({
    ...
    preConfirm: () => {
      ...
      if(ciudad == ""){
        ...
        if (inputObject.id == "otrostrim2q11") {
          document.getElementById("insertCitytrim2q11").innerHTML = "";
          document.getElementById("otrostrim2q11").value = ciudad;
  ...
  Swal.fire({
    ...
    preConfirm: () => {
      ...
      if(uso == ""){
        ...
        if(inputObject.id == "otrostrim2q15"){
          document.getElementById("insertUsetrim2q15").innerHTML = "";
          document.getElementById("otrostrim2q15").value = uso;
          document.getElementById(
            "insertUsetrim2q15"
